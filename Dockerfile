...
# useful tools
RUN apt-get install -y --no-install-recommends vim less net-tools inetutils-ping wget curl git telnet nmap socat dnsutils netcat tree htop unzip jq httpie psmisc iproute2 ssh rsync sudo traceroute
